...
export const TOOLS = [
  ...
  },
  {
    ...
    name: "GPA calculator",
    blurb:
      "Calculate a credit-weighted GPA on a 4.0, 5.0 or 10.0 scale and see every course contribution.",
  },
  {
    href: "/pomodoro-timer",
    name: "Pomodoro study timer",
    blurb:
      "Run focused study and break intervals with adjustable lengths and a visible session count.",
  },
  {
    href: "/study-planner",
    name: "Exam study planner",
    blurb:
      "Turn an exam date, topic count and available study time into a realistic daily revision target.",
  },
];

export const TOOLS_HUB = "/tools";

// The share card every tool page points at. The same image the landing page
// uses, because there is no per-tool artwork and a link with no preview image
// is the worse outcome. One constant so swapping it is one edit rather than
// thirty-seven.
export const TOOL_OG_IMAGE = [
  { url: `${SITE_URL}/body.png`, width: 1200, height: 630 },
];
