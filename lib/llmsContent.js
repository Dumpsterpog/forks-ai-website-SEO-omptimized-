...
- [Weighted GPA calculator](https://forksai.app/gpa-calculator): calculates course-credit-weighted GPA on a selected grading scale.
- [Pomodoro study timer](https://forksai.app/pomodoro-timer): adjustable focus, short-break and long-break intervals that run in the browser.
- [Exam study planner](https://forksai.app/study-planner): converts an exam date, topic count and daily minutes into a revision target.
...
- [How to calculate GPA](https://forksai.app/blog/how-to-calculate-gpa)
- [Pomodoro technique for studying](https://forksai.app/blog/pomodoro-technique-for-studying)
