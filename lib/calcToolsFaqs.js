...
export const NEGATIVE_MARKING_FAQS = [
  {q:"What does 1/3 negative marking mean?",a:"For each wrong answer, deduct one third of the marks awarded for a correct answer. If a correct answer earns 3 marks, the penalty is 1 mark; if it earns 1 mark, the penalty is one third of a mark. Use your paper’s instructions to confirm the scheme."},
  {q:"How do I calculate 1/4 negative marking?",a:"Divide the marks for one correct answer by 4 to get the penalty per wrong answer. With 4 marks per correct, deduct 1 per wrong; with 1 mark per correct, deduct 0.25. Multiply correct answers by the award and subtract wrong answers multiplied by that penalty."},
  {
