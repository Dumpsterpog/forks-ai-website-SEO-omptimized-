// The everyday calculators, in one place, so every page in the set agrees on
// what exists and can cross-link to the rest. Kept separate from
...
// Everything in this set has shipped. A tool that is built but has no route
// yet goes here first, because listing it in CALC_TOOLS would put a 404 in the
// sitemap, the hub, the footers and the cross-link strip.
export const CALC_TOOLS_UNSHIPPED = [];
