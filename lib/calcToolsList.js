...
// Built but not shipped: the route is not in the repository yet, so listing it
// in CALC_TOOLS would put a 404 in the sitemap, the hub, the footers and the
// cross-link strip. Move the entry back into CALC_TOOLS when the page lands.
