...
export const REMNOTE_ALTERNATIVE_FAQS = [
  ...
  {
    q: "Is FORKSAI free?",
    a: "There is a free plan. It covers one AI-generated deck with no cap on the cards in it, unlimited manual decks, the 7 classic study modes with FSRS-5 spaced repetition, live study rooms, browsing the public decks library and progress tracking. The 5 AI study modes (AI Revision, Exam Simulator, Explain Back, Case Study and Interactive Mind Map), Podcast Mode, the Medical Encyclopedia and the PDF Summarizer are on the paid plan. Current prices and limits are on the FORKSAI homepage, which is the only place we quote them so they cannot go stale here.",
  },
  {
