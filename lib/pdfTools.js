// The nine browser-based PDF tools, in one place, so the cross-link strips and
...
export const PDF_TOOLS = [
  ...
  },
  {
    ...
    name: "Watermark PDF",
    blurb:
      "Stamp draft, sample or confidential across the pages, at the angle, size and opacity you pick.",
  },
];
