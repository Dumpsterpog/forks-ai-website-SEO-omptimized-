// The text and developer tools, in one place, so every page in the set
...
// Not shipped: neither route is in the repository yet, so listing them in
// TEXT_TOOLS would put a 404 in the sitemap, the hub, the footers and the
// cross-link strip. Move an entry back into TEXT_TOOLS when its page lands.
export const TEXT_TOOLS_UNSHIPPED = [
  {
