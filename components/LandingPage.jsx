        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          ...
          <div className="bg-white border-2 border-black rounded-xl shadow-[4px_4px_0_#111] p-8 flex flex-col">
            ...
            <div className="flex flex-col gap-2.5 mb-8">
              {["1 AI-generated deck, no card limit", "Unlimited manual decks and folders", "7 study modes including spaced repetition", "FSRS-5 scheduling on every deck", "1 Quick Study session a week (paste and study, no deck)", "Live Study Rooms (up to 5 people)", "Browse the Public Decks library", "Progress tracking and streaks"].map((f, i) => (
