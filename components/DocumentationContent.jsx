...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      "### Premium adds",
      "100 AI flashcard generations per month on the monthly and yearly plans - upload a PDF or paste text and get a complete deck in under 30 seconds, again and again.",
