...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "note", text: "The free plan covers one AI-generated deck, unlimited manual decks, and the revision modes. Generating more decks, the PDF Summarizer, and the Quiz Generator need an active subscription. You can upgrade anytime from the dashboard." },
    ],
  },
  {
    id: "ai-flashcards",
  ...
  },
  {
    ...
    content: [
      ...
      "Manual decks are identical to AI-generated decks in every other way. They appear in Recent Decks, contribute to your streak when created, and can be studied using every revision mode, including on the free plan.",
  ...
  },
  {
    ...
    content: [
      ...
      "Revision modes and FSRS-5 spaced repetition - study any deck as often as you like.",
