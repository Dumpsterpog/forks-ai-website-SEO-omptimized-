...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      "Click Create in the top bar. Manual Flashcards are unlimited on the free plan, and every account gets one free AI-generated deck from an uploaded PDF or pasted text. Premium accounts keep generating after that.",
      "### 4. Start studying",
      ...
      { type: "note", text: "The free plan covers one AI-generated deck, unlimited manual decks, and the 7 classic revision modes. Generating more decks, the PDF Summarizer, and the Quiz Generator need an active subscription. You can upgrade anytime from the dashboard." },
    ],
  },
  {
    id: "ai-flashcards",
  ...
  },
  {
    ...
    content: [
      ...
      "Manual decks are identical to AI-generated decks in every other way. They appear in Recent Decks, contribute to your streak when created, and can be studied using every revision mode your plan includes, free or Premium.",
  ...
  },
  {
    ...
    content: [
      "FORKSAI has a permanent free tier and an optional Premium subscription. The free tier is not a trial - it is a full, usable version of the platform. Premium is for people who want to keep generating with AI.",
      "### Free plan includes",
      "One AI-generated flashcard deck - upload a PDF or paste text and get a complete deck, with no cap on how many cards it holds. This is a one-time unlock, not a monthly allowance.",
      "Manual flashcard creation - create and edit decks by writing your own cards, with no limit on decks or cards.",
      "The 7 classic revision modes and FSRS-5 spaced repetition - study any deck as often as you like.",
      ...
      "### Premium adds",
      "100 AI flashcard generations per month on the monthly and yearly plans, or 25 a week on the weekly plan - upload a PDF or paste text and get a complete deck in under 30 seconds, again and again.",
      ...
      "The AI-powered study modes - Exam Simulator, Explain Back, the AI tutor, Mind Maps, and Case Study Mode.",
      "Priority AI processing - faster generation during high-demand periods.",
      "### Subscription plans",
      "Premium is available on four billing cycles: 1-day (24-hour access, auto-renews daily), weekly ($4.99, renews weekly, cancel anytime), monthly, and yearly (best per-day value). Every one of them is a recurring subscription, not a one-time pass. Pricing is displayed at checkout.",
      "### Upgrading",
      "Click Upgrade in the dashboard top bar at any time. Premium activates immediately after payment - no waiting, no setup.",
      "### What happens if you cancel",
      "You retain Premium access until the end of your current billing period. After that, the AI tools are locked and you return to the free tier, where your decks and every revision mode still work.",
